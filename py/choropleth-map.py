...
def export_gdp_per_capita():
    ...
    combined_df_simplified = combined_df[combined_df['Year'].isin([2020])]
    
    combined_df_simplified = combined_df_simplified[['Country', 'GDP_per_Capita']]
